        ...
        <View style={styles.container}>
            <View style={{ flexDirection: "row", height: 100, width: Dimensions.get('window').width, backgroundColor: "#024063", borderBottomRightRadius: 15, alignItems: "center", justifyContent: "space-between" }}>
                <View style={{ flex: 1, justifyContent: "flex-start", flexDirection: "row", alignItems: "center" }}>
                    ...
                    <Text style={[styles.lableText, { marginLeft: 10, fontSize: 18, fontWeight: "400", color: "#fff", width: "auto", marginTop: 0 }]}>महत्वपूर्ण जानकारी</Text>
                </View>
            </View>
            ...
            <View style={{ marginHorizontal: 15, justifyContent: "center", marginTop: 20 }}>
                ...
                <Text style={styles.text2}>5. विस्तृत नियम एवं शर्तों के लिए
                    <Text style={[styles.text2, { color: '#1AA7FF' }]} onPress={() => navigation.navigate("PrivacyPolicyDetail")}> नियम एवं शर्तें पृष्ठ पर जाएं।</Text>
                </Text>
            </View>
